                ...
                <div className='enableSinais__cards'>
                    ...
                    <div className='cardBuscaSinalEnable'>
                        ...
                        {data.map((sinais_encontrados, index) => (
                            ...
                            <br />
                            <img src={"https:web.esinais.software:8080/files/bandeiras/" +bandeiras[index]+".png"} alt="hello" height={80} width={100}/>
                        </div>
                                                
                        <div className='div-img-sinal-asso-Enable'>
                            <img src={"https://web.esinais.software:8080/files/sinais/" + sinais_encontrados.enderecoSinal} alt="hello" height={150} width={130}/>
                            <br />
                            <span className='font-bold text-title'>Sinal</span>
 
                        </div>
                        <div className='div-img-sinal-asso-Enable'>
                            <img src={"https://web.esinais.software:8080/files/imgAssociativa/" + sinais_encontrados.enderecoImgAssociativa} alt="hello" height={150} width={130}/>
                            <br />
